...
2. [AI 检查项规则验证](docs/测试-02-AI检查项规则验证.md)：数据集、Baseline、指标、发布门槛和 Period 快照测试。
...
代码与旧文档冲突时以代码为事实来源；新的产品取舍以需求评审结论为准。实际 DDL、索引、生产配置、权限入口和状态码仍需在授权环境只读核验。
...
同时补充试点区域、门店、AI 员工、人工负责人和 1 至 3 条风险规则的业务名单。
